...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    TextEditingController emailTxtField = new TextEditingController();
    TextEditingController passTxtField = new TextEditingController();
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "Signup Now",
                style: TextStyle(fontSize: 32, fontFamily: 'Poppins-SemiBold'),
              ),
              const SizedBox(height: 10),
              const Text(
